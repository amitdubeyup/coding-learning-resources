...
| Frontend | [`frontend/`](frontend/) | React (19 + compiler), Angular, Vue, HTML/CSS, GraphQL |
| Data | [`data/`](data/) | SQL, indexing, NoSQL, CAP, caching |
| DevOps | [`devops/`](devops/) | containers, AWS, CI/CD, observability |
| AI/ML | [`ai-ml/`](ai-ml/) | LLM foundations, RAG, agents, evaluation, MLOps |
...
- **AI/ML** — LLM foundations (transformers, RoPE, scaling, LoRA/QLoRA, reasoning
  models) plus RAG, agents, evaluation.
...
as reference), the `os-internals/` OS topic files (index reframed; topics not
individually rewritten), and a Pydantic-v1 → v2 pass on the FastAPI notes.
